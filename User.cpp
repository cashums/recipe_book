...
User::~User() {
    // Clear the search history and favorite recipes vectors
    searchingHistory_vec.clear();
    favoriteRecipe_vec.clear();

    cout << "User object for \"" << userName << "\" is being destroyed." << endl;
}
